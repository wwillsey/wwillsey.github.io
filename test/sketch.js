...
function setup() {
  ...
  for (var i = 0; i < 100; i++) {
    boids[i] = new Boid(random(width), random(height), random(3,20));
  }
}
...
Boid.prototype.render = function() {
  let color1 = color(0, 57, 11);
  let color2 = color(16, 13, 155);
  let c = lerpColor(color1, color2, this.position.x / width);
  fill(c)
  noStroke();
